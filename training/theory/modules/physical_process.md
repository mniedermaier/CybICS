...
<svg viewBox="0 0 520 150" role="img" aria-label="Gas pressure process">
  ...
  <g text-anchor="middle" font-size="11">
    <text x="40" y="70" font-size="11">supply</text>
    ...
    <text x="157" y="78">GST</text><text x="157" y="93" font-size="11">storage</text>
    <rect x="235" y="60" width="60" height="40" rx="6" fill="#ff6b00" opacity="0.6"/>
    <text x="265" y="84" fill="#1a1a1a" font-size="11">compressor</text>
    ...
    <text x="373" y="78" fill="#1a1a1a">HPT</text><text x="373" y="93" font-size="11" fill="#1a1a1a">high pressure</text>
    <line x1="418" y1="70" x2="470" y2="45" stroke="currentColor" stroke-dasharray="4 3" marker-end="url(#p)"/>
    <text x="470" y="38" font-size="11">blowout</text>
  </g>
</svg>
...
The PLC keeps HPT in a safe band; forcing it past critical triggers the blowout.
