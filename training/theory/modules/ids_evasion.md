...
<svg viewBox="0 0 520 120" role="img" aria-label="Low and slow under the threshold">
  ...
  <text x="424" y="48" font-size="11">threshold</text>
  ...
  <text x="20" y="108" font-size="11" opacity="0.7">a few writes, well spaced &mdash; each window stays below the line</text>
</svg>
