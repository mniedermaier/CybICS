...
<svg viewBox="0 0 520 150" role="img" aria-label="Segmenting attacker from control zone">
  ...
  <text x="95" y="24" text-anchor="middle" font-size="11">attacker zone</text>
  <rect x="45" y="60" width="100" height="34" rx="6" fill="#ff6b00" opacity="0.3"/><text x="95" y="82" text-anchor="middle" font-size="11">attack box</text>
  <rect x="350" y="30" width="150" height="90" rx="8" fill="#ff6b00" opacity="0.1" stroke="#ff6b00"/>
  <text x="425" y="24" text-anchor="middle" font-size="11">control zone</text>
  <rect x="370" y="48" width="110" height="28" rx="5" fill="#ff6b00" opacity="0.6"/><text x="425" y="67" text-anchor="middle" font-size="11" fill="#1a1a1a">PLC</text>
  <rect x="370" y="82" width="110" height="28" rx="5" fill="#ff6b00" opacity="0.5"/><text x="425" y="101" text-anchor="middle" font-size="11" fill="#1a1a1a">OPC-UA</text>
  ...
  <text x="260" y="120" text-anchor="middle" font-size="11" opacity="0.8">no path from the attacker to the controllers</text>
</svg>
